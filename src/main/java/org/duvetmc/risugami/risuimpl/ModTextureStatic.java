...
public class ModTextureStatic extends class_89 {
    ...
    public ModTextureStatic(int slot, int size, int dst, BufferedImage source) {
        super(slot);
        this.field_2040 = size;
        this.field_2757 = dst;
        this.method_1945(ModLoader.getMinecraftInstance().field_323);
        ...
        this.field_510 = new byte[targetWidth * targetHeight * 4];
    ...
    public void update() {
        for(int i = 0; i < this.pixels.length; ++i) {
            ...
            this.field_510[i * 4 + 0] = (byte)r;
            this.field_510[i * 4 + 1] = (byte)g;
            this.field_510[i * 4 + 2] = (byte)b;
            this.field_510[i * 4 + 3] = (byte)a;
        }

        this.oldanaglyph = this.field_771;
    }

    public void method_1945() {
        if (this.oldanaglyph != this.field_771) {
            this.update();
        }
    }
